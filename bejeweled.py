        ...
        for match in matches:
            ...
            if len(match) == 3:
                ...
                for pos in match:
                    ...
                    pygame.mixer.music.play('match0.wav')
...
class Cell:
    def __init__(self, image, pos):
        ...
        self.special_images = [pygame.image.load(os.path.join("images",'gem0_special.png')).convert_alpha(),
...
class Timer:
    def __init__(self):
        ...
        self.timeLimit = int(self.currentTime + 60)
...
def runBejeweled():
    ...
    #Text for comments
    candyText = Text(64, "candy!", color=(255,0,0))
    sweetyText = Text(64, "sweety!", color=(255,0,0))
    candyText.showing, sweetyText.showing = False, False #Don't always show the comments, only when the player makes a good combo
    comments = [candyText, sweetyText]
